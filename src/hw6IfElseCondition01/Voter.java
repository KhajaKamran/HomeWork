 ...
 * After the main method, define a int type variable  name is age 
 * and initialize your age. 
 ...
 * d) And finally the outcome will be "Please add a valid age". 
 * In the above 4 condition, use appropriate key word like if, else if, else to execute that you are a voter or not. 
 * Please organize the code (very important). 
 * don't give any white space. 
