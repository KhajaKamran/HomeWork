...
public abstract class MedicalSchool extends NursingSchool implements LawSchool{     //abstract class created
	 ...
	 *   Ans:-Abstract Class can inherit only one Abstract Class or only one regular class by extends keywords.
	 *   Ans:-Abstract Class can't inherit Interface by extends keywords.
	 *   Ans:Abstract Class can inherit interface more then one interface by implements keywords. 
	 *    
	 ...
	 *    Ans:-two inheritance .Here abstract class MedicalSchool inherit abstract class NursingSchool by extends keywords and inherit interface LawSchool by implements keywords.
	 *    */
